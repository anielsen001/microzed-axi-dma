...
# Configure the PS: Generate 50MHz clock, Enable GP0 and HP0, Enable interrupts
set_property -dict [list CONFIG.PCW_USE_S_AXI_HP0 {1} CONFIG.PCW_USE_M_AXI_GP0 {1} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_IRQ_F2P_INTR {1} CONFIG.PCW_USE_S_AXI_ACP {0} ] [get_bd_cells processing_system7_0]
...
connect_bd_net -net [get_bd_nets rst_ps7_0_49M_peripheral_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins rst_ps7_0_49M/peripheral_aresetn]
